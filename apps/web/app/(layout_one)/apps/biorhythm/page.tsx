...
const moduleName = `Biorhythm`;
const pageTitle = `${moduleName} - ${process.env.NEXT_PUBLIC_APP_TITLE}`;
const pageDescription = `Track your physical, emotional, and intellectual cycles based on your birth date.`;
const pageUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/apps/biorhythm`;
...
export default async function BiorhythmPage() {
  return (
    <>
