...
export default function WidgetDraggableMusicPreview() {
  ...
  return (
    <div
      ...
      className={`pointer-events-auto flex w-full max-w-full overflow-hidden rounded-lg border bg-card shadow-sm ${isVisible ? "opacity-100" : "pointer-events-none opacity-0"}`}
    >
      <div className="relative flex w-full flex-col">
        <div
          ...
          onDrop={handleDrop}
          className="flex h-8 w-full cursor-move items-center gap-2 rounded-t-lg border-b border-border bg-muted/50 px-3 select-none"
        >
