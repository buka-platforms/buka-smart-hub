...
const pageDescription = `Contact ${process.env.NEXT_PUBLIC_BUKA_APP_TITLE} for any inquiries or feedback.`;
const pageUrl = `${process.env.NEXT_PUBLIC_BUKA_BASE_URL}/contact`;
