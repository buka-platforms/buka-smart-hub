...
const moduleName = `Movie Preview`;
const pageTitle = `${moduleName} - ${process.env.NEXT_PUBLIC_APP_TITLE}`;
const pageDescription = `A quick way to search for movie and watch to their trailer.`;
const pageUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/apps/music-preview`;
...
export default async function MoviePreviewPage() {
  return (
    <>
      ...
      <div className="mt-11 flex w-full justify-center">
        <img
          src="/assets/images/illustration_movie_preview.svg"
          alt="Movie Preview"
