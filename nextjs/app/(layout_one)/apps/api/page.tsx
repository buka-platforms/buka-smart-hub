...
const pageDescription = `Some useful APIs from Buka's engineering team.`;
const pageUrl = `${process.env.NEXT_PUBLIC_BUKA_BASE_URL}/apps/api`;
  ...
  return (
    <>
      ...
      <div className="mt-11 flex w-full justify-center">
        <img
          src="/assets/images/illustration_api.svg"
          alt="API (Application Programming Interface)"
