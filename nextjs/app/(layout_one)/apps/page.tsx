...
const pageDescription = `Enjoy some apps from ${process.env.NEXT_PUBLIC_BUKA_APP_TITLE} that everyone can use everyday, everywhere, anytime.`;
const pageUrl = `${process.env.NEXT_PUBLIC_BUKA_BASE_URL}/apps`;
