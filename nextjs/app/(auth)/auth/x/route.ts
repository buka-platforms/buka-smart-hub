...
export async function GET(request: Request) {
  ...
  const clientId = process.env.NEXT_PUBLIC_BUKA_X_CLIENT_ID;
  const clientSecret = process.env.SECRET_BUKA_X_CLIENT_SECRET;
  const redirectUri = process.env.NEXT_PUBLIC_BUKA_X_REDIRECT_URI;
