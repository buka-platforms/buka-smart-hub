...
export async function GET(request: Request) {
  ...
  // Get the user info from identity provider based on the access token on the response, use the id_token to get the user info
  ...
  let userSession;
  let userId;
  const identityProviderCode = "microsoft";
  const identityProviderName = "Microsoft";
