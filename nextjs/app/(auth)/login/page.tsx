  ...
  return (
    <>
      ...
      <section className="body-font relative h-screen text-gray-600">
        ...
        <div className="z-10 container mx-auto flex h-screen max-w-lg flex-wrap items-center px-5">
          <div className="flex w-full flex-col rounded-lg bg-slate-50 bg-clip-padding p-10">
            ...
            <div className="flex flex-col gap-y-2">
              <a
                href={authGoogleUrl}
                className="flex w-full transform items-center justify-center rounded-md bg-blue-500 px-6 py-2 text-sm font-medium text-white transition-colors duration-200 focus:bg-blue-400 focus:outline-hidden"
              >
              ...
              <a
                href={authGitHubUrl}
                className="flex w-full transform items-center justify-center rounded-md bg-slate-950 px-6 py-2 text-sm font-medium text-white transition-colors duration-200 focus:bg-slate-600 focus:outline-hidden"
              >
              ...
              <a
                ...
                className="flex w-full transform items-center justify-center rounded-md bg-[#0077B5] px-6 py-2 text-sm font-medium text-white transition-colors duration-200 focus:bg-[#0077DD] focus:outline-hidden"
              >
                <svg
                  width="512"
                  height="512"
              ...
              <a
                href={authDiscordUrl}
                className="flex w-full transform items-center justify-center rounded-md bg-[#5468ff] px-6 py-2 text-sm font-medium text-white transition-colors duration-200 focus:bg-[#5488ff] focus:outline-hidden"
              >
                <svg
                  width="512"
                  height="512"
              ...
              <a
                ...
                className="flex w-full transform items-center justify-center rounded-md bg-slate-700 px-6 py-2 text-sm font-medium text-white transition-colors duration-200 focus:bg-slate-600 focus:outline-hidden"
              >
                <svg
