...
// Storage keys
const SELECTED_CHANNEL_KEY = "widgetLiveTVSelectedChannel";
const FAVORITE_CHANNELS_KEY = "widgetLiveTVFavorites";
const VOLUME_KEY = "widgetLiveTVVolume";
const MUTED_KEY = "widgetLiveTVMuted";
